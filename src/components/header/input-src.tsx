import { $, component$, QwikMouseEvent, useStore } from "@builder.io/qwik";
...
export const InputSrc = component$(() => {
  ...
  const handleDropList = $((event: QwikMouseEvent<HTMLDivElement>) => {
    ...
    if (id !== "input-src-qwik") state.open = false;
  });

  return (
    <div window:onClick$={handleDropList} class={{'drop-shadow-lg':state.open}}>
